...
const Header = () => {
  ...
  return (
    <div className="flex flex-col w-full h-20 md:flex-row justify-between">
      <div className="flex justify-between items-center px-3 relative">
        <NavLink to="/">
          <img className="w-30 y-20" src={logoImg} alt="" />
        </NavLink>
        <button
          className="size-fit border border-transparent focus:border-black focus:rounded-[28%] md:hidden"
          onClick={() => showMenu()}
        >
