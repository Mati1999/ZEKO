      ...
      <main>
        <div className="bg-[url(/homeImg.jpg)] bg-cover bg-no-repeat bg-center w-full h-100 flex flex-col justify-center items-center px-5 md:h-150 md:mt-25">
          <div className="w-full flex flex-col gap-3 justify-center items-center">
            ...
            <div className="bg-gray-50 w-full h-20 flex justify-between pl-2 rounded-md md:pl-5 lg:w-2/3">
              <input
                className="w-full text-sm focus:outline-none md:text-lg lg:text-xl"
                type="text"
